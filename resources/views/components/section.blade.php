<div class="container my-5">
    ...
    <div class="row">
        <div class="col-12 col-lg-4"><img src="{{asset('img\OIP.jfif')}}" alt="" class="img-fluid card v-100"><h3 class="text-white">Titolo</h3>
        <p  class="text-white">questa è la <strong>recensione</strong></p>
    </div>
        <div class="col-12 col-lg-4"><img src="{{asset('img\pila.jfif')}}" alt="" class="img-fluid card v-100"><h3 class="text-white">Titolo</h3>
        <p  class="text-white">questa è la <strong>recensione</strong></p>
